...
def main():
    ...
    # network archtecture
    parser.add_argument('--num-enc', type=int, default=2,
                        help='number of encoders')
    parser.add_argument('--conf-file', type=str, default=None, required= True,
                        help='Filename of multi-encoder configuration (json)')
    # CTCs related
    parser.add_argument('--sharectc', type=str2bool, default=False,
                        help='Flag to share ctc for encoders')
    parser.add_argument('--ctc-ws-trn', default="0.5_0.5", type=str,
                        help='weight for each per-encoder CTC during training')
    parser.add_argument('--ctc-ws-dec', default="0.5_0.5", type=str,
                        help='weight for each per-encoder CTC during validation decoding in training')
    # loss
    ...
    if args.backend == "pytorch":
        from espnet.asr.asr_pytorch import train_mulenc
        train_mulenc(args)
    else:
