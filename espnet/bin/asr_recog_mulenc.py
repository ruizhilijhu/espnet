...
def main():
    ...
    parser.add_argument('--ctc-ws', default="0.5_0.5", type=str,
                        help='weight for each per-encoder CTC during decoding')
    # task related
    ...
    if args.backend == "pytorch":
        from espnet.asr.asr_pytorch import recog_mulenc
        recog_mulenc(args)
    else:
