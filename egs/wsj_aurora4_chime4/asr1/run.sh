...
if [ ${stage} -le 1 ]; then
    ...
    fbankdir=fbank
    tasks="\
    wsj_train_si284 wsj_test_dev93 wsj_test_eval92 \
    aurora4_train_si84_multi aurora4_train_si84_clean aurora4_test_eval92 aurora4_dev_0330 \
    "
    for x in ${tasks}; do
    ...
    # split aurora4_test_eval92 into subcondition directories
    for c in $aurora4_conds; do
