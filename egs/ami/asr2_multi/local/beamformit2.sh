...
while read line; do
  ...
  mkdir -p $odir/$line
  mv $odir/$line/${line}.del  $odir/$line/${line}_SMDM8.del
  mv $odir/$line/${line}.del2 $odir/$line/${line}_SMDM8.del2
  mv $odir/$line/${line}.info $odir/$line/${line}_SMDM8.info
  mv $odir/$line/${line}.weat $odir/$line/${line}_SMDM8.weat
  mv $odir/$line/${line}.wav  $odir/$line/${line}_SMDM8.wav
